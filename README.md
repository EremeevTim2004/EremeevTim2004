...
Мой опыт работы:
* В данный момент над проетктом, который является аналогом [продажи.рф](https://xn--80ahhi0afh.xn--p1ai/), Project name - "Sales scope". Мои обязанности на проекте - Teamlead, FastAPI (python) backend programmer, data base & services architecter.
